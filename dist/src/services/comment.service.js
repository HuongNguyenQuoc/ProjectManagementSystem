...
const assertTaskInProject = async (projectId, taskId, requesterId) => {
...
export const createCommentService = async (projectId, taskId, input, requesterId) => {
...
export const listCommentsByTaskService = async (projectId, taskId, requesterId) => {
    await assertTaskInProject(projectId, taskId, requesterId);
